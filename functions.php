<?php
/**
 * Msadiq functions and definitions
 *
...
if ( ! function_exists( 'msadiq_setup' ) ) :
	/**
	 ...
	 */
	function msadiq_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Msadiq, use a find and replace
		 * to change 'msadiq' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'msadiq', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'msadiq' ),
			)
		);
...
add_action( 'after_setup_theme', 'msadiq_setup' );
 ...
 */
function msadiq_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'msadiq_content_width', 640 );
}
add_action( 'after_setup_theme', 'msadiq_content_width', 0 );
...
function msadiq_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Widget 3', 'msadiq' ),
			'id'            => 'sidebar-3',
			'description'   => esc_html__( 'Add widgets here.', 'msadiq' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Widget 4', 'msadiq' ),
			'id'            => 'sidebar-4',
			'description'   => esc_html__( 'Add widgets here.', 'msadiq' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
...
add_action( 'wp_enqueue_scripts', 'msadiq_scripts' );
